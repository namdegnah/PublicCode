...
class UserSQL {
  ...
  static const insertUsers = 'INSERT INTO ${UserNames.tableName}(${UserNames.id}, ${UserNames.name}, ${UserNames.email}, ${UserNames.password}) VALUES (1, "Paul", "paul_brassington@hotmail.com", "a") ,(2, "Campbell", "cambell@weir.com", "a") , (3, "Ting", "yuting_yuting@hotmail.com", "a") , (4, "Roy", "royston@google.com", "a") , (5, "Stephen", "stephen@yahoo.com", "a") , (6, "Jiayuan", "jiayuan@google.com", "a")';
    static List<String> getSQL() {
...
class AccountTypesSQL{
  static const accountTypesSql = 'CREATE TABLE ' +
    AccountTypesNames.tableName +
    '(' +
    AccountTypesNames.id + 
    ' INTEGER PRIMARY KEY, ' +
    AccountTypesNames.typeName +
    ' TEXT, ' +
    AccountTypesNames.iconPath +
    ' TEXT )';
  static const accountTypesIndex = 'CREATE UNIQUE INDEX index_account_types ON ' + AccountTypesNames.tableName + '(id);';
  static const accountTypeEntry = 'INSERT INTO ' +
    AccountTypesNames.tableName +
    '(' +
    AccountTypesNames.id +
    ', ' +
    ...
    AccountTypesNames.iconPath +
    ') VALUES ' +
    '(1, "Bank Account", "assets/images/accounts/ac03.jpg") ,' +
    '(2, "Savings", "assets/images/accounts/ac01.jpg") , ' +
    '(3, "Simple Savings", "assets/images/accounts/ac04.jpg") , ' +
    '(4, "Credit Card", "assets/images/accounts/ac02.jpg") , ' +
    '(5, "Mortgage", "assets/images/accounts/ac06.jpg") , ' +
    '(6, "Loan", "assets/images/accounts/ac05.jpg")';
  static List<String> getSQL(){
...
class CategorySQL {
  ...
  static const categoryInsert = 'INSERT INTO ' +
      CategoryNames.tableName +
      '(' +
      CategoryNames.id +
      ', ' +
      ...
      '(14, "Bank Interest", "interest given by the bank", "assets/images/category_icons/c008.jpg", 1), ' +
      '(15, "Bank Charges", "charges made by the bank", "assets/images/category_icons/c007.jpg", 1)';
  static List<String> getSQL(){
...
class RecurrencesSQL {
  static const recurrenceSql = 'CREATE TABLE ' +
      ...
      ' TEXT ' +
      ')';
  static const recurrenceInsert = 'INSERT INTO ' +
      RecurrenceNames.tableName +
      '(' +
      RecurrenceNames.id +
      ', ' +
      ...
      '(9, "Weekly End Date", "Weekly recurrence that finishes after a specific date", "assets/images/recurrence_icons/r063.jpg", 0, 0, "2020-10-10T00:00:00.000") ,' +
      '(10, "Monthly End Date", "Monthly recurrence that finishes after a specific date", "assets/images/recurrence_icons/r019.jpg", 1, 0, "2020-10-10T00:00:00.000") ,' +
      '(11, "Quarterly End Date", "Quarterly recurrence that finishes after a specific date", "assets/images/recurrence_icons/r021.jpg", 2, 0, "2020-10-10T00:00:00.000") ,' +
      '(12, "Yearly End Date", "Yearly recurrence that finishes after a specific date", "assets/images/recurrence_icons/r062.jpg", 3, 0, "2020-10-10T00:00:00.000")';
  static const recurrenceIndex = 'CREATE UNIQUE INDEX index_recurrences ON ' + 
    RecurrenceNames.tableName + '(' + 
    RecurrenceNames.id + ');';
  static List<String> getSQL(){
...
class TransferSQL{
  static const transferSql = 'CREATE TABLE ' +
      ...
      TransfersNames.id +
      ' INTEGER PRIMARY KEY, ' +
      TransfersNames.user_id +
      ' INTEGER REFERENCES ' + 
        UserNames.tableName + '(' + 
        UserNames.id + ') ON DELETE CASCADE, ' +      
      ...
      ' INTEGER, ' +
      TransfersNames.categoryId +
      ' INTEGER, ' +
      TransfersNames.recurrenceId +
      ' INTEGER, ' +
      TransfersNames.plannedDate +
      ' TEXT, ' +
      TransfersNames.amount +
      ' REAL, ' +
      TransfersNames.usedForCashFlow +
      ' INTEGER, ' +
      TransfersNames.processed +
      ' INTEGER ' +
      ')';  
  static const transferIndex = 'CREATE UNIQUE INDEX index_transfers ON ' + 
    TransfersNames.tableName + '(' + 
    TransfersNames.id + ');';
  static const transferUserIndex = 'CREATE INDEX index_transfers_users ON ' + 
    TransfersNames.tableName + '(' + 
    TransfersNames.user_id + ');';
  static List<String> getSQL(){
...
class TransactionsSQL{
  static const transactionSql = 'CREATE TABLE ' +
      ...
      TransactionNames.id +
      ' INTEGER PRIMARY KEY, ' +
      TransactionNames.user_id +
      ' INTEGER REFERENCES ' + 
        UserNames.tableName + '(' + 
        UserNames.id + ') ON DELETE CASCADE, ' +       
      TransactionNames.title +
      ' TEXT, ' +
      TransactionNames.description +
      ' TEXT, ' +
      TransactionNames.accountId +
      ' INTEGER, ' + 
      TransactionNames.categoryId +
      ' INTEGER, ' +
      TransactionNames.recurrenceId +
      ' INTEGER, ' +
      TransactionNames.plannedDate +
      ' TEXT, ' +
      TransactionNames.amount +
      ' REAL, ' +
      TransactionNames.credit +
      ' INTEGER, ' +
      TransactionNames.usedForCashFlow +
      ' INTEGER, ' +
      TransactionNames.processed +
      ' INTEGER ' +
      ')';
  static const transactionIndex = 'CREATE UNIQUE INDEX index_transactions ON ' + 
    TransactionNames.tableName + '(' + 
    TransactionNames.id + ');';
  static const transactionUserIndex = 'CREATE INDEX index_transactions_users ON ' + 
    TransactionNames.tableName + '(' + 
    TransactionNames.user_id + ');';
  static List<String> getSQL(){
...
class AccountSavingsSQL{
  static const savingsAccountSql = 'CREATE TABLE ' +
      AccountSavingsNames.tableName +
      '(' +
      AccountNames.id +
      ' INTEGER PRIMARY KEY, ' +
      ...
      ' INTEGER, ' +
      AccountSavingsNames.savingsRate +
      ' REAL, ' +
      AccountSavingsNames.save_recurrenceId +
      ' INTEGER, ' +
      AccountSavingsNames.chargeRate +
      ' DOUBLE, ' +
      AccountSavingsNames.charge_recurrenceId +
      ' INTEGER, ' +
      AccountSavingsNames.accountStart +
      ' INTEGER, ' +
      AccountSavingsNames.accountEnd +
      ' INTEGER, ' +      
      AccountSavingsNames.savingsAccountId +
      ' INTEGER, ' +
      AccountSavingsNames.chargeAccountId +
      ' INTEGER, ' +  
      AccountSavingsNames.lastInterestAdded +
      ' INTEGER, ' +                
      AccountSavingsNames.interestAccrued +
      ' DOUBLE PRECISION, ' +
      AccountSavingsNames.capitalCeiling +
      ' DOUBLE ' +
      ')';
  static const savingsAccountIndex = 'CREATE UNIQUE INDEX index_account_saving ON ' + AccountSavingsNames.tableName + '(id);'; 
  // USER SAVINGS 
  static const userSavingsSql = 'CREATE TABLE ' +
      UserSavingsNames.tableName +
      '(' +
      UserSavingsNames.user_id +
      ' INTEGER REFERENCES ' + 
        UserNames.tableName + '(' + 
        UserNames.id + ') ON DELETE CASCADE, ' +
      UserSavingsNames.account_id +
      ' INTEGER REFERENCES ' + 
        AccountSavingsNames.tableName + '(' + 
        AccountNames.id + ') ON DELETE CASCADE' +
      ')';  
  static const userSavingsIndex = 'CREATE UNIQUE INDEX index_user_account_savings ON ' + 
    UserSavingsNames.tableName + '(' + 
    UserSavingsNames.user_id + ', ' + 
    UserSavingsNames.account_id + 
    ');';
...
class AccountSimpleSavingsSQL{
  static const simpleSavingsAccountSql = 'CREATE TABLE ' +
      AccountSimpleSavingsNames.tableName +
      '(' +
      AccountNames.id +
      ' INTEGER PRIMARY KEY, ' +
      AccountNames.accountName +
      ...
      AccountNames.usedForCashFlow +
      ' INTEGER, ' +
      AccountSimpleSavingsNames.savingsRate +
      ' REAL, ' +
      AccountSimpleSavingsNames.addInterestId +
      ' INTEGER, ' +     
      AccountSimpleSavingsNames.chargeRate +
      ' DOUBLE, ' +
      AccountSimpleSavingsNames.charge_recurrenceId +
      ' INTEGER, ' +
      AccountSimpleSavingsNames.accountStart +
      ' INTEGER, ' +
      AccountSimpleSavingsNames.accountEnd +
      ' INTEGER, ' +      
      AccountSimpleSavingsNames.lastInterestAdded +
      ' INTEGER, ' +                
      AccountSimpleSavingsNames.interestAccrued +
      ' DOUBLE PRECISION ' +
      ')';
  ...
  // USER SIMPLE SAVINGS 
  static const userSimpleSavingsSql = 'CREATE TABLE ' +
      UserSimpleSavingsNames.tableName +
      '(' +
      UserSimpleSavingsNames.user_id +
      ' INTEGER REFERENCES ' + 
        UserNames.tableName + '(' + 
        UserNames.id + ') ON DELETE CASCADE, ' +
      UserSimpleSavingsNames.account_id +
      ' INTEGER REFERENCES ' + 
        AccountSimpleSavingsNames.tableName + '(' + 
        AccountNames.id + ') ON DELETE CASCADE' +
      ')';  
  static const userSimpleSavingsIndex = 'CREATE UNIQUE INDEX index_user_account_simple_savings ON ' + 
    UserSimpleSavingsNames.tableName + '(' + 
    UserSimpleSavingsNames.user_id + ', ' + 
    UserSimpleSavingsNames.account_id + 
    ');';
...
class SettingsSQL{
  ...
  static String settingsInsert = 'INSERT INTO ' +
      SettingNames.tableName +
      '(' +
      SettingNames.id +
      ', ' +
      ...
      '(5, "End Date")'; 
  // USER SETTINGS
  static const userSettingSql = 'CREATE TABLE ' +
    UserSettingNames.tableName + 
    '(' +
    UserSettingNames.user_id +
    ' INTEGER REFERENCES ' + 
      UserNames.tableName + '(' + 
      UserNames.id + ') ON DELETE CASCADE, ' +
    UserSettingNames.setting_id +
    ' INTGER REFERENCES ' + 
      SettingNames.tableName + '(' + 
      SettingNames.id + ') ON DELETE CASCADE, ' +
    UserSettingNames.value +
    ' INTEGER )';
  static const userSettingsIndex = 'CREATE UNIQUE INDEX index_user_setting ON ' + UserSettingNames.tableName + 
    '(' + 
    UserSettingNames.user_id + ', ' + 
    UserSettingNames.setting_id + ');';
  static List<String> getSQL(){
...
class DataInsert{
  ...
  static const userSettingsSql = 'INSERT INTO user_settings(user_id, setting_id, value) VALUES ' +
    '(1, 1, 1), (1, 2, 1), (1, 3, -1), (1, 4, 1), (1, 5, 30251841), ' + 
    '(2, 1, 1), (2, 2, 1), (2, 3, -1), (2, 4, 1), (2, 5, 30251841);'; 
...
class AcccountAddInterestSQL {
  static const addInterestSql = 'CREATE TABLE ' +
      AddInterestNames.tableName +
      '(' +
      AddInterestNames.id +
      ' INTEGER PRIMARY KEY, ' +
      AddInterestNames.title +
      ' TEXT, ' +
      AddInterestNames.description +
      ' TEXT, ' +
      AddInterestNames.iconPath +
      ' TEXT, ' +
      AddInterestNames.type +
      ' INTEGER ' +
      ')';
  static const addInterestInsert = 'INSERT INTO ' +
      AddInterestNames.tableName +
      '(' +
      AddInterestNames.id +
      ', ' +
      ...
      AddInterestNames.type +
      ') VALUES ' +
      '(1, "End of Period", "Interest added at the end of the Savings Period", "assets/images/add_interest_icons/ai001.png", 0) ,' +
      '(2, "1st each Month", "Interest added at the first of each month", "assets/images/add_interest_icons/ai002.png", 1) ,' +
      '(3, "End of each Month", "Interest added at the end of each month", "assets/images/add_interest_icons/ai003.png", 2) ,' +
      '(4, "End of year", "Interest added at the end of each year", "assets/images/add_interest_icons/ai004.png", 3) , ' +
      '(5, "Start of quarter", "Interest added at the start of each quarter", "assets/images/add_interest_icons/ai005.png", 4) ,' +
      '(6, "End of quarter", "Interest added at the end of each quarter", "assets/images/add_interest_icons/ai006.png", 5) ,' +
      '(7, "End of fiscal year", "Interest added at the end of fiscal year", "assets/images/add_interest_icons/ai007.png", 6)';
  static const addInterestIndex = 'CREATE UNIQUE INDEX index_add_interest ON ' + 
    AddInterestNames.tableName + '(' + 
    AddInterestNames.id + ');';
  static List<String> getSQL(){
