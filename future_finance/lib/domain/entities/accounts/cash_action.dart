...
class CashActionDayEvent extends CashAction with OnThisDay {

  CashActionDayEvent({
    required TransBase tb, 
    required Account account, 
    required double amount, 
    required DateTime plannedDate}) : super(tb: tb, account: account, amount: amount, plannedDate: plannedDate);
