...
TextStyle squadTitle = GoogleFonts.roboto(fontSize: 10, fontWeight: FontWeight.w800, letterSpacing: 1.1, height: 2);
TextStyle teamTitle = GoogleFonts.roboto(fontSize: 12, fontWeight: FontWeight.w400, letterSpacing: 0.9, height: 1.2);
TextStyle teamAddress = GoogleFonts.roboto(fontSize: 10, fontWeight: FontWeight.w800, letterSpacing: 1, height: 1.1);
TextStyle squadName = GoogleFonts.roboto(fontSize: 10, fontWeight: FontWeight.w400, letterSpacing: 1.1, height: 1.3);
