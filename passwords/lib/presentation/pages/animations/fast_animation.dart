          ...
          if(widget._size) Positioned(
            ...
            child: Transform.scale(
              ...
              child: Transform.rotate(
                ...
                child: const Image(image: AssetImage('assets/images/password_animation.png'),),
              ),
            ),
          ),
          Positioned(
            top: 250 + (400 - _singleTimeFraction * 400),
            //left: widget._size ? 430 : 20,
            left: 20,
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Free Forever', style: anyStyle(start: dashboardHi20, color: textFast, fontSize: 20, fontWeight: FontWeight.w700),),
                ...
                Container(
                  ...
                  child: anyText(text: 'Export your data to another device or other apps', style: anyStyle(start: dashboardHi20, fontSize: getFontSize(width), fontWeight: FontWeight.w400)),
                ),   
              ],
            ),
          ),          
