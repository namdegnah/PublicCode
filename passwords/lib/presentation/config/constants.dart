...
enum Formatters { justNumberFormatter, lengthLimiterFormatter, sortCodeFormatter, debitCardFormatter, expiryDateInputFormatter, mobileNumberFormatter, amexCardFormatter}
enum Validators {isRequired, requiredAndLength, emailValidator, strongPasswordValidator, mediumPasswordValidator, weakPasswordValidator, urlValidator, numericValidator, phoneNumberValidator, debitCardValidation, requiredAndLengthMaxSet}
enum PasswordFieldsNumbers{password, description, url, username, email, accountNumber, pin, sortCode, digit3SecurityCode, digit4SecurityCode, phoneNumber, name, cardNumber, amexCardNumber, expiryDate, passcode, notes}
