import '../../entities/temp_convert/teacher_weblogin.dart';
...
Future<void> convertTeacherWebLogin() async {

  List<Password> passwords = [];
  var jsonText = await rootBundle.loadString('assets/json/teacher_weblogin.json');
  List<TeacherWebLogin> data = modelTWLJson(jsonText);
