...
class AppSQL {
  ...
  static const groupIndex =
      'CREATE UNIQUE INDEX index_groups ON ${GroupNames.tableName}(${GroupNames.id});';
  static const insertGroups =
      '''INSERT INTO ${GroupNames.tableName}(${GroupNames.id}, ${GroupNames.name}) 
    VALUES 
    (1, "Developer"), 
    (2, "Games"), 
    (3, "Houses"), 
  ...
  static const passwordIndex =
      'CREATE UNIQUE INDEX index_password ON ${PasswordNames.tableName}(${PasswordNames.id});';
  static const passwordInsert = '''INSERT INTO ${PasswordNames.tableName}
    ...
    ${PasswordNames.isValidated})   
    VALUES 
    (1, 1, 1, "Paulb5352?", "notes", "Amazon Login", "www.amazon.co.uk", "paul_brassington", "brassington22@gmail.com", "", "5352", "", "", "07507592537", "", "", "", "", "", "", 3, 0), 
    (2, 1, 2, "Malcome3", "notes", "BBC Login", "www.bbc.co.uk", "", "paul_brassington@hotmail.com", "", "", "506832", "", "", "Bill Bloggs", "", "", "", "", "",  5, 0)
    ''';
  // Type
  ...
  static const insertTypes =
      '''INSERT INTO ${TypeNames.tableName}(${TypeNames.id}, ${TypeNames.name}, ${TypeNames.fields}, ${TypeNames.passwordValidationId}) 
    VALUES 
    ...
    (10, "Bank Account", "11001111001100011", 5),
