...
class LocalDataSource extends AppDataSource {
  ...
  @override
  Future<List<Map<String, dynamic>>> getDataOrderById(String tableName) async {
    try {
      return await DBHelper.getDataOrderById(tableName);
    } catch (error) {
      throw ServerException(error.toString());
    }
  }
  ...
  @override
  Future<List<Map<String, dynamic>>> getDataWhere({required String table, required String columns, required String where, required int args}) async {
           
    try {
      return await DBHelper.getDataWhere(
          table: table, columns: columns, where: where, args: args);
    } catch (error) {
      throw ServerException(error.toString());
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getAllDataWhereAny(String tableName, String field, int id) async {
    ...
    try {
      return await DBHelper.getAllDataWhereAny(
          table: tableName, field: field, args: id);
    } catch (error) {
      throw ServerException(error.toString());
    }
  }
  ...
  Future<List<Map<String, dynamic>>> getAllDataFullIntQuery(String table, List<String> columns, List<int> args) async {
    ...
    try {
      return await DBHelper.getAllDataFullIntQuery(
          tableName: table, columns: columns, args: args);
    } catch (error) {
      throw ServerException(error.toString());
    }
  }
  ...
  Future<void> deleteMultiple(
      String tableName, List<String> fields, List<int> ids) async {
    try {
  ...
  @override
  Future<void> update(
      String tableName, int id, Map<String, Object> data) async {
    try {
  ...
  @override
  Future<void> updateWhere(String tableName, List<String> columns,
      List<int> args, Map<String, Object> data) async {
    try {
  ...
  @override
  Future<List<Map<String, dynamic>>> getDataLinkWhere({required String tableName, required String linkTable, required String tableField, required String linkField, required String whereClause}) async {
        
    try {
      return await DBHelper.getDataLinkWhere(
          tableName, linkTable, tableField, linkField, whereClause);
    } catch (error) {
      throw ServerException(error.toString());
    }
  }
