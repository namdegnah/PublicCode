...
abstract class AppDataSource{
  Future<int> insert(String tableName, Map<String, Object> data);
  Future<List<Map<String, dynamic>>> getData(String tableName);
  Future<List<Map<String, dynamic>>> getDataOrderById(String tableName);  
  Future<List<Map<String, dynamic>>> getDataWhere({required String table, required String columns, required String where, required int args});
  ...
  Future<void> update(String tableName, int id, Map<String, Object> data);
  ...
  Future<List<Map<String, dynamic>>> getDataLinkWhere({required String tableName, required String linkTable, required String tableField, required String linkField, required String whereClause});
